...
export default function Message({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative max-sm:ml-6 ${
          message.reaction.length > 0 ? "mb-4" : ""
        }`}
      >
        {/* sender user message */}
      ...
      ${
        ...
        >
            ...
            >
              ...
              <div className="absolute m-3">
                ...
                <p className="dark:text-dark_text_2 text-xs">
                  {message.message_replied.message.length > 100
                    ? `${message.message_replied.message.substring(0, 100)}...`
                    : message.message_replied.message}
                </p>
              </div>
            </div>
          ) : null}
          ...
          {/* ReactionPreview */}
          <ReactionPreview
            open={openReactionPreview}
            onClose={() => setOpenReactionPreview(false)}
            setOpenReactionPreview={setOpenReactionPreview}
            message={message}
            _id={user._id}
            me={me}
          />
