        ...
        <div>
            ...
            <div className=''>
                    ...
                    <input
                           ...
                           dark:checked:border-green_2 dark:checked:after:border-primary dark:checked:after:bg-green_2 
                           dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:border-green_2 
            ...
            <div className='mx-auto my-4 w-96 flex gap-3 items-end justify-end'>
                ...
                onClick={() => setShowTheme(false)}
                    className='btn w-[100px] mb-2 text-teal-600 hover:text-teal-500 dark:bg-dark_hover_1 border border-gray-600'
                >
                Cancel
                </button>
                <button
                type='button'
                onClick={handleTheme}
                className='btn w-[70px] mb-2 dark:text-dark_bg_1 hover:text-dark_bg_1 dark:bg-teal-600 hover:bg-teal-500'
                >
                OK
                </button>
            </div>
