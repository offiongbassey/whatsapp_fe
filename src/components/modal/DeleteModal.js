...
export default function DeleteModal({  open, onClose, message, setOpenModal, deleteMessageHandler }) {
  return (
      ...
      `}>
          ...
          <div className="">
                  ...
                  <div className="mx-auto my-4 w-96 flex flex-col items-end">
                    ...
                    <button className="btn w-[150px] mb-6 text-teal-600 hover:text-teal-500 dark:bg-dark_hover_1 border border-gray-600"
